...
ROUTE_REST_STOPS = {
    ...
    # Highway 5 north from Jeddah - the corridor in the project's own problem
    # statement (Jeddah <-> Tabuk, roughly 10 hours). Fractions follow the real
    # towns on that road: Rabigh, Yanbu, Umluj, Al Wajh, Duba. Same caveat as
    # the rest of this file - the town positions are real, the specific station
    # names are illustrative and want a Google Maps pass before anyone treats
    # them as ground truth.
    frozenset({"Jeddah", "Tabuk"}): {
        "from": "Jeddah",
        "stops": [
            {"name": "SASCO Rest Area - Rabigh", "type": "rest_area", "fraction": 0.19},
            {"name": "Aldrees Station - Yanbu Junction", "type": "fuel", "fraction": 0.38},
            {"name": "SASCO Rest Area - Umluj", "type": "rest_area", "fraction": 0.51},
            {"name": "Aldrees Station - Al Wajh", "type": "fuel", "fraction": 0.69},
            {"name": "SASCO Rest Area - Duba", "type": "rest_area", "fraction": 0.85},
        ],
    },
    frozenset({"Madinah", "Tabuk"}): {
        "from": "Madinah",
        "stops": [
            {"name": "Aldrees Station - Khaybar Road", "type": "fuel", "fraction": 0.25},
            {"name": "SASCO Rest Area - Al Ula Junction", "type": "rest_area", "fraction": 0.55},
            {"name": "Aldrees Station - Tabuk Approach", "type": "fuel", "fraction": 0.85},
        ],
    },
    frozenset({"Jeddah", "NEOM"}): {
        "from": "Jeddah",
        "stops": [
            {"name": "SASCO Rest Area - Rabigh", "type": "rest_area", "fraction": 0.18},
            {"name": "Aldrees Station - Yanbu Junction", "type": "fuel", "fraction": 0.36},
            {"name": "SASCO Rest Area - Al Wajh", "type": "rest_area", "fraction": 0.66},
            {"name": "Aldrees Station - Duba", "type": "fuel", "fraction": 0.83},
        ],
    },
